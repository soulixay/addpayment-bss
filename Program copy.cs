...
//             string sql = $"SELECT msisdn, amount,seq_number, user_id FROM public.refund_payment_refillcard;";
...
//                             WriteLog("AddjustPayment", detail.Trim());
